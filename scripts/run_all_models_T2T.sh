...
#1
#DATA_DIR_UNS="/home/omnisky/Wyk_team/sherlock/dataset/PDE/Irregular/Aletheia/single_layer"
#DATA_DIR_STR="/home/omnisky/Wyk_team/sherlock/dataset/PDE/Irregular/Aletheia/single_layer"
#CRACK_TYPE=1
#2
...
#CRACK_TYPE=2
#3
#DATA_DIR_UNS="/home/omnisky/Wyk_team/sherlock/dataset/PDE/Irregular/Aletheia/typeII_double-layer"
#DATA_DIR_STR="/home/omnisky/Wyk_team/sherlock/dataset/PDE/Irregular/Aletheia/typeII_double-layer"
#CRACK_TYPE=3
#4
...
#CRACK_TYPE=4
#5
#DATA_DIR_UNS="/home/omnisky/Wyk_team/sherlock/dataset/PDE/Irregular/Aletheia/typeI_multi-layer"
#DATA_DIR_STR="/home/omnisky/Wyk_team/sherlock/dataset/PDE/Irregular/Aletheia/typeI_multi-layer"
#CRACK_TYPE=5
#6
...
MODELS_UNS="Transolver,MLP,FNO3d,GeoFNO,FFNO,FCNO,LNO,LaMO"
MODELS_STR="Transolver,MLP,FNO3d,GeoFNO,FFNO,FCNO,LNO,LaMO"

run_phase() {
  local TAG="$1" DTYPE="$2" ROOT="$3" OOD_TYPE="$4" MODELS_LIST="$5"

  echo "[RUN] T2T | tag=${TAG} | dtype=${DTYPE} | OOD=${OOD_TYPE} | root=${ROOT}"
  CMD=(python "${PY}"
       --mode T2T
       --data_root "${ROOT}"
       --data_type "${DTYPE}"
...
echo "[MAIN] All T2T experiments finished."
