...
if hasattr(torch, "cuda"):
    smart_fwd = torch.cuda.amp.custom_fwd
    smart_bwd = torch.cuda.amp.custom_bwd
else:
    smart_fwd = partial(torch.amp.custom_fwd, device_type="cuda")
    smart_bwd = torch.amp.custom_bwd
